...
struct SpellEntry
{
    ...
    //uint32    FacingCasterFlags;                            // not found in 1.12
    uint32    TargetAuraState;                              // 17
    //uint32    CasterAuraStateNot;                           // not found in 1.12
    //uint32    TargetAuraStateNot;                           // not found in 1.12
    ...
    //uint32    Totem[2];                                     // not in 1.12?
                                                            // 40-41 UNKNOWN or Totem[2] but doesn't mach 
...
//    int32     EffectMiscValueB[3];                          // missing in 1.12?
    ...
    //uint32    TotemCategory[2];                             // not found in 1.12
    //uint32    AreaId;                                       // not found in 1.12
    //uint32    SchoolMask;                                   // not found in 1.12
