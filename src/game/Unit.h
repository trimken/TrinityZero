...
class TRINITY_DLL_SPEC Unit : public WorldObject
{
    public:
        ...
        float GetStat(Stats stat) const { return float(GetUInt32Value(UNIT_FIELD_STR+stat)); }
        void SetStat(Stats stat, int32 val) { SetStatInt32Value(UNIT_FIELD_STR+stat, val); }
