...
class BattleGround
{
    ...
    public:
        ...
        uint32 GetAlivePlayersCountByTeam(uint32 Team) const;   //[TZERO] used in arenas to correctly handle death in spirit of redemption / last stand etc. (killer = killed) cases
